...
print("Class shape... ",classNo.shape)
...
print("train1 shape... ",X_train.shape)
print("test1 shape... ",X_test.shape)
print("validation1 shape... ",X_validation.shape)
